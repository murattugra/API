...
ve checkout date'in 2020-09-30 oldugunu test edin
    ...
    public void test03(){
       ...
       String url="https://restful-booker.herokuapp.com/booking/7";
        ...
        response.then().assertThat().statusCode(200).contentType(ContentType.JSON);//ContebtType.JSOn content type nin JSOn olup olmadigini verir

        response.then().assertThat().body("firstname",equalTo("Mary")
                            ,"lastname",equalTo("Jones")
                            ,"bookingdates.checkin",equalTo("2015-06-02")
                            ,"bookingdates.ckeckout",equalTo("2018-09-29"));
